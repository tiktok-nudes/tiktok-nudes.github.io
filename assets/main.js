...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.container.style1', { style: 'zoom-in', speed: 1000, intensity: 1, delay: 0, staggerOrder: '', replay: false });
